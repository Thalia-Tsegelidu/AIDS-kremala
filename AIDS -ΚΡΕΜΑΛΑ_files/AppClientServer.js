...
addAppClientTranslation("EN",
                        "APPCLIENT_CHARACTERS","abcdefghijklmnopqrstuvwxyz");
addAppClientTranslation("EN",
                        "APPCLIENT_FULLSCREEN","Show App in fullscreen");
addAppClientTranslation("EN",
                        "APPCLIENT_HINTLINK","Show task description");
addAppClientTranslation("EN",
                        "APPCLIENT_HELPLINK","Show help");
addAppClientTranslation("EN",
                        "APPCLIENT_HELPDESCRIPTION","Help");
addAppClientTranslation("EN",
                        "APPCLIENT_TASKDESCRIPTION","Task");
addAppClientTranslation("EN",
                        "APPCLIENT_GIVEPARAM","Provide a value for parameter:");
addAppClientTranslation("EN",
                        "APPCLIENT_CONNECTIONLOST","The connection to the app server was interrupted. A new connection is established.");

addAppClientTranslation("EN",
                        "APPCLIENT_VIDEODELTED","The video is not yet or no longer available on YouTube.");
addAppClientTranslation("EN",
                        "APPCLIENT_VIDEOFORBIDDEN","The author has forbidden to embed the audio/video in other websites.");
addAppClientTranslation("EN",
                        "APPCLIENT_VIDEOWRONGURL","YouTube URL is invalid.");

addAppClientTranslation("EN",
                        "APPCLIENT_READSPEECH","Listen!");
